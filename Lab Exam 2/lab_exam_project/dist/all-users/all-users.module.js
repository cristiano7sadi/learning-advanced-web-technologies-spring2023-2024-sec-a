...
const all_users_service_1 = require("./all-users.service");
const all_users_controller_1 = require("./all-users.controller");
...
exports.AllUsersModule = AllUsersModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [all_users_controller_1.AllUsersController],
        providers: [all_users_service_1.AllUsersService],
        exports: [all_users_service_1.AllUsersService],
    })
], AllUsersModule);
